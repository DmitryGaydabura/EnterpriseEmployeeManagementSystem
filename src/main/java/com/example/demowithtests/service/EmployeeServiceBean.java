...
public class EmployeeServiceBean implements EmployeeService {
    ...
    public List<Employee> findAllFrench() {
        return employeeRepository.findAllFrench();
    }

    @Override
    public List<Employee> findAllFrenchGraph() {
        return employeeRepository.findAllByCountry("France");
    }

    @Override
    public List<Employee> findAllMr() {
        return employeeRepository.findAllMr();
    }

    @Override
    public List<Employee> findAllMrGraph() {
        return employeeRepository.findAllByNameStartingWith("Mr.");
    }
}
